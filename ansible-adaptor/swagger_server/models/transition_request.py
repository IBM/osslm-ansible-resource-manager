...
class TransitionRequest(Model):
    ...
    """
    def __init__(self, resource_manager_id: str=None, deployment_location: str=None, resource_type: str=None, transition_name: str=None, resource_name: str=None, context: object=None, properties: object=None):
        """
    ...
    def from_dict(cls, dikt) -> 'TransitionRequest':
        ...
        :param dikt: A dict.
        :type: dict
        :return: The transitionRequest of this TransitionRequest.
